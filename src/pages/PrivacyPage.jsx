    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700 text-white">
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-cyan-300 mb-8">Privacy Policy</h1>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            ...
            <p className="text-blue-100 mb-4">
              At Bot360AI, we respect your privacy and are committed to protecting your personal data. 
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">2. Information We Collect</h2>
            <p className="text-blue-100 mb-4">
          ...
          {/* Use of Information */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">3. How We Use Your Information</h2>
            <p className="text-blue-100 mb-4">
          ...
          {/* Data Security */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">4. Data Security</h2>
            <p className="text-blue-100 mb-4">
          ...
          {/* Cookies */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">5. Cookies</h2>
            <p className="text-blue-100 mb-4">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">6. Service Providers</h2>
            <p className="text-blue-100 mb-4">
          ...
          {/* Children's Privacy */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">7. Children's Privacy</h2>
            <p className="text-blue-100">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">8. Changes to This Privacy Policy</h2>
            <p className="text-blue-100">
          ...
          {/* Contact */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">9. Contact Us</h2>
            <p className="text-blue-100">
