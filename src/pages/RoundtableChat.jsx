...
const RoundtableChat = () => {
  ...
  return (
    _jsxs("div", {
      className: "min-h-screen bg-gradient-to-b from-indigo-950 via-indigo-900 to-indigo-800 py-6 px-4 md:px-6",
      children: [
        _jsxs("div", {
          ...
          children: [
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsx("h1", {
                  className: "text-2xl md:text-3xl font-bold text-center text-cyan-300 mb-2",
                ...
                _jsx("div", {
                  ...
                  children: participants.map(participant => (
                    _jsxs("div", {
                      ...
                      children: [
                        _jsx("div", {
                          className: "w-12 h-12 md:w-14 md:h-14 rounded-full overflow-hidden border-2 border-cyan-400/50",
                          children: _jsx("img", {
                        ...
                        _jsx("span", {
                          className: "text-indigo-100 text-xs mt-1 text-center",
                        ...
                        if (message.role === 'user') {
                          return (
                            _jsx("div", {
                              ...
                              children: _jsx("div", {
                              className: "bg-cyan-600/70 text-white rounded-2xl rounded-tr-none px-4 py-3 max-w-[80%] shadow-md",
                      ...
                      isTyping && (
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsx("div", {
                              className: "w-2 h-2 rounded-full bg-cyan-400 animate-pulse delay-200"
                            }),
                            _jsx("span", {
                              className: "text-sm",
            ...
            _jsx("form", {
              ...
              children: [
                _jsx("input", {
                  ...
                  disabled: isTyping,
                  className: `flex-1 bg-white/10 border border-white/30 rounded-full py-3 px-4 text-white placeholder-indigo-100/70 
