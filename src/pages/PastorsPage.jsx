          ...
          children: [
            ...
            _jsx("section", {
              ...
              children: _jsxs("div", {
                ...
                children: [
                  _jsx("h1", {
                    className: "text-4xl md:text-5xl lg:text-6xl font-extrabold text-cyan-400 mb-6 tracking-tight drop-shadow-lg",
                  ...
                  _jsx("p", {
                    ...
                    children: "Bot360AI helps small groups and individuals go deeper with Scripture—safely, at scale, and with biblical guidance."
                  }),
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx(Link, {
                        ...
                        className: "px-8 py-4 bg-cyan-400 hover:bg-cyan-300 text-indigo-900 font-bold rounded-lg text-lg transition-colors shadow-lg",
            ...
            /* Pilot cohort banner */
            _jsx("section", {
              className: "bg-cyan-400/20 backdrop-blur-sm py-4 mb-20",
              children: _jsx("div", {
              ...
              children: _jsxs("div", {
                children: [
                  _jsx("h2", {
                    ...
                    style: { fontFamily: 'inherit' },
                    children: "Why pastors choose Bot360AI"
                  }),
                  _jsx("div", {
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("div", {
                            className: "w-12 h-12 bg-cyan-400/20 rounded-full flex items-center justify-center mb-4",
                            children: _jsx("svg", {
                          ...
                          _jsxs("ol", {
                            ...
                            children: [
                              _jsxs("li", {
                                ...
                                children: [
                                  _jsx("div", {
                                    className: "w-8 h-8 bg-cyan-400 rounded-full flex items-center justify-center flex-shrink-0 mt-1",
                                    children: _jsx("span", {
              ...
              children: _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("p", {
                    ...
                    children: "We're constantly improving Bot360AI with new features to better serve your church's discipleship needs."
                  }),
                  _jsx("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("p", {
                            className: "text-blue-100 text-sm",
                            children: "Embed Bot360AI directly into your church website for a seamless member experience."
                          })
                        ]
                      })
                    ]
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("p", {
                        ...
                        children: "We're inviting the first 10 churches to join our pilot program. Get full access to Bot360AI for 60 days to experience the impact on your ministry."
                      }),
                      _jsxs("div", {
              ...
              children: _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("p", {
                    ...
                    children: "Many churches ask about integrating Bot360AI directly into their website. We offer several options:"
                  }),
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("p", {
                            className: "text-blue-100 text-sm",
                            children: "Add a chat widget to your existing church website that opens Bot360AI in a popup or sidebar."
                          })
                        ]
                      }),
                      _jsxs("div", {
