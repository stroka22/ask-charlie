...
const RoundtableSetup = () => {
  ...
  if (isLoading && characters.length === 0) {
    return (
      _jsx("div", {
        className: "min-h-screen bg-gradient-to-b from-indigo-950 via-indigo-900 to-indigo-800 py-10 px-4 md:px-6",
        children: _jsxs("div", {
          className: "max-w-4xl mx-auto bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/15 shadow-xl",
          children: [
            _jsx("h1", {
              className: "text-3xl md:text-4xl font-bold text-center text-cyan-300 mb-6",
          ...
          children: _jsxs("form", {
            ...
            children: [
              _jsx("h1", {
                className: "text-3xl md:text-4xl font-bold text-center text-cyan-300 mb-6",
                style: { fontFamily: 'inherit' },
                children: "Create a Roundtable"
              }),
              
              _jsx("p", {
                className: "text-white/80 text-center mb-8",
                children: "Select multiple assistants to discuss a topic together. They will respond to each other and to your messages."
              }),
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("input", {
                    ...
                    placeholder: "e.g., Team alignment, Onboarding tips, Product feedback...",
                    className: "w-full bg-white/10 border border-white/30 rounded-lg py-3 px-4 text-white placeholder-indigo-100/70 focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
                  })
                ]
              }),
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx("input", {
                    ...
                    className: "h-5 w-5 rounded border-gray-300 text-cyan-400 focus:ring-cyan-400"
                  }),
                  _jsxs("label", {
                    htmlFor: "autoStart",
                    className: "text-cyan-300 font-medium select-none",
                    children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      _jsxs("label", {
                        className: "block text-cyan-300 font-medium",
                        children: [
                          "Select Characters ",
                          _jsxs("span", {
                            className: "text-white/70 text-sm",
                  ...
                  _jsx("div", {
                    ...
                    children: _jsx("input", {
                      ...
                      className: "w-full bg-white/10 border border-white/30 rounded-full py-2 px-4 text-white placeholder-indigo-100/70 focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
                    })
                  }),
                              ...
                              _jsxs("div", {
                                ...
                                children: [
                                  ...
                                  _jsx("p", {
                                    ...
                                    children: character.description || character.scriptural_context || "Assistant"
                                  })
                                ]
                              })
                            ]
