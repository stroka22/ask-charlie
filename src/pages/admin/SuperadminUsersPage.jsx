...
const SuperadminUsersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-blue-600 text-white px-4 md:px-8 pt-32 pb-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="flex items-center space-x-2 text-sm">
            <Link to="/" className="text-cyan-300 hover:text-cyan-400 transition-colors">
              Home
            </Link>
            <span>&gt;</span>
            <Link to="/admin" className="text-cyan-300 hover:text-cyan-400 transition-colors">
              Admin
            </Link>
            <span>&gt;</span>
          ...
          <Link
            to="/admin"
            className="hidden mt-4 md:mt-0 inline-block px-4 py-2 bg-cyan-400 text-indigo-900 rounded-lg font-semibold hover:bg-cyan-300 transition-colors"
          >
            Back to Admin
          </Link>
        </div>
        ...
        {isSuperAdmin && (
          <div className="flex justify-end mb-4">
            ...
            className="px-4 py-2 bg-cyan-400 text-indigo-900 rounded-lg hover:bg-cyan-300 transition-colors"
            >
              New Organization
            </button>
          </div>
            ...
            <div className="relative bg-blue-800 w-11/12 max-w-md rounded-lg shadow-xl p-6 z-10">
              ...
              <form onSubmit={handleCreateOrganization}>
                ...
                <input
                  ...
                  className="w-full mb-4 px-3 py-2 bg-blue-700 border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium ${
                      savingOrg
                        ...
                        : 'bg-cyan-400 text-indigo-900 hover:bg-cyan-300'
                    }`}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-blue-700 border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
              />
            </div>
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="px-2 py-1 bg-blue-700 border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 text-sm"
              >
      ...
      <div className="mt-8">
        <a href="/admin" className="inline-block px-4 py-2 bg-cyan-400 text-indigo-900 rounded-lg font-semibold hover:bg-cyan-300 transition-colors">Back to Admin</a>
      </div>
    </div>
  </div>
);
