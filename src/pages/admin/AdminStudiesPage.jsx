    ...
    _jsxs("div", {
      ...
      children: [
        ...
        _jsxs("div", {
          ...
          children: [
            _jsx("h1", {
              className: `text-3xl md:text-4xl font-extrabold ${embedded ? 'text-gray-800' : 'text-cyan-300'} mb-2 tracking-tight drop-shadow-lg`,
              style: { fontFamily: 'inherit' },
              children: "Content Studies Administration"
            }),
            _jsx("p", {
              className: `${embedded ? 'text-gray-600' : 'text-blue-100'}`,
              children: "Manage assistant-guided studies and lessons"
            })
          ]
        }),
                      ...
                      children: [
                        ...
                        _jsxs("ul", {
                          ...
                          children: [
                            ...
                            _jsx("li", {
                              children:
                                "Set owner_slug in the form to your organization (e.g., acme-co)"
                            }),
                            _jsx("li", {
                              children:
            ...
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    _jsx("h2", {
                      className: `text-xl font-bold ${embedded ? 'text-gray-800' : 'text-cyan-300'}`,
                      children: "Studies"
                    }),
                    _jsx("button", {
                ...
                isLoading ? (
                  _jsx("div", {
                    ...
                    children: _jsx("div", {
                      className: "animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-cyan-400"
                    })
                  })
                ) : studies.length === 0 ? (
                  _jsx("div", {
                      ...
                      _jsxs("div", {
                        className: `
                          ...
                          ${selectedStudy?.id === study.id 
                            ? embedded ? 'bg-blue-50 border-primary-400' : 'bg-blue-700/50 border-cyan-400/50' 
                        ...
                        children: [
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("h3", {
                                className: `font-semibold ${embedded ? 'text-gray-800' : 'text-cyan-300'} mb-1`,
                    ...
                    _jsxs("div", {
                      children: [
                        ...
                        _jsx("textarea", {
                          ...
                          className: "w-full bg-white border border-gray-300 text-gray-900 rounded-lg py-2 px-3 focus:border-primary-500 focus:ring-primary-500 h-24",
                          placeholder: "Special guidance or persona prompt for the assistant"
                        })
                      ]
                    }),
                    ...
                    _jsxs("div", {
                      children: [
                        ...
                        _jsxs("select", {
                          ...
                          className: "w-full bg-white border border-gray-300 text-gray-900 rounded-lg py-2 px-3 focus:border-primary-500 focus:ring-primary-500",
                          children: [
                            _jsx("option", { value: "", children: "-- Select an assistant --" }),
                  ...
                  children: [
                    ...
                    _jsxs("div", {
                      children: [
                        _jsx("label", {
                          className: "block text-blue-200 mb-1",
                          children: "Reference Tags (comma separated)"
                        }),
                        _jsx("input", {
                          type: "text",
                          ...
                          className: "w-full bg-white border border-gray-300 text-gray-900 rounded-lg py-2 px-3 focus:border-primary-500 focus:ring-primary-500",
                          placeholder: "e.g., Section 1, Module A"
                        })
                      ]
                    }),
                    ...
                    _jsxs("div", {
                      children: [
                        ...
                        _jsx("p", {
                          ...
                          children: "These will be used as suggested questions for the assistant to discuss with the user."
                        })
                      ]
                    }),
