              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <select
                    ...
                    onChange={handleInputChange}
                    className="flex-1 px-3 py-2 bg-blue-700 border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
                  >
                  ...
                  {formData.maxUses === 'custom' && (
                    <input
                      ...
                      min="1"
                      max="100"
                      className="w-24 px-3 py-2 bg-blue-700 border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
                    />
                  )}
                </div>
                <p className="text-xs text-gray-300 mt-1">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium ${
                  creating
                    ...
                    : 'bg-cyan-400 text-indigo-900 hover:bg-cyan-300 transition-colors'
                }`}
              >
