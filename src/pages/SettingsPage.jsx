              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    notificationsEnabled ? 'bg-cyan-400' : 'bg-gray-500'
                  }`}
                >
                  <span 
          ...
          <div className="bg-blue-800 rounded-lg shadow-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <input
                ...
                className="flex-1 px-3 py-2 bg-blue-700 border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 uppercase tracking-widest"
              />
              <button
