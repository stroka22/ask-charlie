      ...
      <div className="min-h-screen bg-blue-900 text-white">
        <div className="container mx-auto px-4 py-8">
          <div className="bg-[rgba(255,255,255,0.05)] rounded-lg p-8 text-center">
            ...
            <Link
              to="/login"
              className="px-4 py-2 bg-cyan-400 text-indigo-900 rounded-lg font-semibold hover:bg-cyan-300 transition-colors"
            >
              Log In
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-blue-900 text-white">
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-cyan-300">Your Conversations</h1>
              ...
              {conversations
                ...
                <div
                  ...
                  className={`p-4 rounded-lg transition-colors ${
                    conv.is_favorite
                      ? 'bg-[rgba(34,211,238,0.08)] hover:bg-[rgba(34,211,238,0.12)] border border-cyan-400/30'
                    ...
                    {renamingConversationId === conv.id ? (
                      ...
                      <div className="flex-1 flex items-center space-x-2">
                        <input
                          ...
                          className="flex-1 p-1 text-indigo-900 rounded border border-blue-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                          autoFocus
                        />
                        <button
                          onClick={async () => {
                      ...
                      <>
                        <h3 className="flex-1 text-xl font-semibold text-cyan-300 flex items-center">
