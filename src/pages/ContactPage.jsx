    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700 text-white">
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl font-bold text-cyan-300 mb-4">Contact Us</h1>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">Quick Options</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <Link 
                to="/faq" 
                className="flex-1 px-4 py-3 bg-cyan-400 hover:bg-cyan-300 text-indigo-900 rounded-lg text-center transition-colors flex items-center justify-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">Send us a Message</h2>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-blue-900/50 border border-blue-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400"
                  required
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-blue-900/50 border border-blue-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400 h-32"
                  required
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                className="w-full px-4 py-3 bg-cyan-400 hover:bg-cyan-300 text-indigo-900 rounded-lg font-semibold transition-colors"
              >
                Send Message
              </button>
            </form>
