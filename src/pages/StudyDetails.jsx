          ...
          children: _jsxs("div", {
            ...
            children: [
              ...
              _jsx("div", {
                ...
                children: _jsxs(Link, {
                  to: "/",
                  className: "inline-flex items-center text-blue-100 hover:text-cyan-300 text-sm",
                  children: [
                    _jsx("svg", {
              ...
              _jsx("div", {
                ...
                children: _jsxs("button", {
                  ...
                  className: "flex items-center text-blue-100 hover:text-cyan-300 transition-colors",
                  children: [
                    _jsx("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                  ...
                  children: [
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        /* Title */
                        _jsx("h1", {
                          className: "text-3xl md:text-4xl font-extrabold text-cyan-400 mb-4 tracking-tight",
                                ...
                                children: _jsxs("div", {
                                  children: [
                                    _jsxs("div", {
                                      ...
                                      children: [
                                        _jsxs("h3", {
                                          className: `font-semibold ${study.is_premium && !isPremium ? 'text-gray-400' : 'text-cyan-300'}`,
                                          children: [
                    ...
                    (study.is_premium && !isPremium) && (
                      _jsx("div", {
                        className: "mt-8 bg-gradient-to-r from-cyan-500/20 to-cyan-600/20 backdrop-blur-sm rounded-xl p-6 border border-cyan-500/30",
                        children: _jsxs("div", {
                          className: "text-center",
                          children: [
                            _jsx("h3", {
                            ...
                            _jsx("button", {
                              ...
                              className: "px-6 py-3 bg-cyan-400 text-indigo-900 font-medium rounded-lg hover:bg-cyan-300 transition-colors",
