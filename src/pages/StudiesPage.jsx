    ...
    _jsxs(_Fragment, {
      children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("div", {
                    ...
                    children: _jsxs(Link, {
                      to: "/",
                      className: "inline-flex items-center text-indigo-100 hover:text-cyan-300 text-sm",
                      children: [
                        _jsx("svg", {
                  ...
                  _jsx("h1", {
                    className: "text-4xl md:text-5xl font-extrabold text-cyan-300 mb-4 tracking-tight drop-shadow-lg",
                    style: { fontFamily: 'inherit' },
                    children: "Guided Studies"
                  }),
                  _jsx("p", {
                    className: "text-indigo-100 text-lg max-w-3xl mx-auto",
                    children: "Explore guided studies with structured lessons and reflections."
                  })
                ]
              }),
                  ...
                  children: _jsxs("div", {
                    children: [
                      ...
                      _jsx("p", {
                        ...
                        children: "We're preparing guided studies for you. Check back soon for new content!"
                      }),
                      _jsx(Link, {
                        to: "/",
                        ...
                        children: [
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsx("p", {
                                className: "text-indigo-100 mb-4 line-clamp-2",
                          ...
                          (study.is_premium && !isPremium) && (
                            _jsx("div", {
                              ...
                              children: _jsx("div", {
                                  className: "px-4 py-2 bg-cyan-400 text-gray-900 font-medium rounded-lg",
        ...
        _jsx(UpgradeModal, {
          ...
          message: "Upgrade to access premium guided studies."
        })
      ]
    })
  );
