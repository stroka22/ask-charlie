...
export default function SalesPage() {
  ...
  const subjectLine2 = "Bring Scripture to Life: Bot360AI for [Church Name]";
  
  const shortEmailTemplate = `
Dear [Name],

I wanted to share an exciting tool that's helping churches deepen engagement with Scripture. Bot360AI lets your members have meaningful conversations with Bible characters, making study more interactive and applicable to modern life.
...
Bot360AI (https://faithtalkai.com) enables believers to have meaningful conversations with Bible characters, bringing ancient wisdom into modern contexts. Rather than just reading Scripture, members can ask questions, explore difficult passages, and see how biblical principles apply to today's challenges.
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Grow the Kingdom with <span className="text-cyan-400">AI-Powered</span> Bible Conversations
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/signup" className="bg-cyan-400 hover:bg-cyan-300 text-indigo-900 font-bold py-3 px-8 rounded-lg text-lg transition duration-300">
                Start Free
              </Link>
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-transparent rounded-lg flex items-end">
              <div className="p-6 md:p-8">
                <h2 className="text-3xl md:text-4xl font-bold text-white">THE <span className="text-cyan-400">COMPLETE</span> BIBLE</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6 text-center">What is Bot360AI?</h2>
            <div className="bg-blue-50 p-8 rounded-xl shadow-md">
              ...
              <p className="text-lg mb-4">
                Unlike generic AI tools, Bot360AI is specifically designed for biblical engagement, with every response rooted in Scripture and theological understanding. It's a powerful tool for churches, small groups, and individuals seeking to grow in their faith journey.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-bold text-blue-900 mb-3 flex items-center">
                  <span className="w-8 h-8 bg-cyan-400 text-indigo-900 rounded-full flex items-center justify-center text-sm font-bold mr-3">✓</span>
                  User Management
                </h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-blue-50 p-8 rounded-xl">
              ...
              <div className="mt-8 p-4 bg-blue-100 rounded-lg">
                ...
                <p>
                  Bot360AI is designed to supplement, not replace, Scripture study and pastoral guidance. We're committed to responsible AI use that serves the Church and honors God's Word.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-blue-50 p-6 rounded-lg">
                <p className="italic mb-4">"Bot360AI has transformed our small group discussions. Being able to 'ask' Paul about his letters or have Moses explain the Exodus brings Scripture to life in ways we never imagined."</p>
                <p className="font-bold text-blue-900">— Pastor Michael, Grace Community Church</p>
              </div>
              
              <div className="bg-blue-50 p-6 rounded-lg">
                <p className="italic mb-4">"Our youth group is actually excited about Bible study now! The interactive nature of Bot360AI meets them where they are technologically while deepening their biblical understanding."</p>
      ...
      <section className="py-16 bg-white border-t border-gray-200">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mb-8">Share Bot360AI with your team using these ready-made resources.</p>
      ...
      <section className="py-16 bg-white border-t border-gray-200">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center mb-8">Use these templates to share Bot360AI with your church leadership team or congregation.</p>
