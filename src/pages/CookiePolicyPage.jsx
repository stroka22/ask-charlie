    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700 text-white">
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-cyan-300 mb-8">Cookie Policy</h1>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            ...
            <p className="text-blue-100 mb-4">
              This Cookie Policy explains how Bot360AI uses cookies and similar technologies to recognize you when you 
          ...
          {/* What are Cookies */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">2. What are Cookies?</h2>
            <p className="text-blue-100 mb-4">
            ...
            <p className="text-blue-100">
              Cookies set by the website owner (in this case, Bot360AI) are called "first-party cookies." Cookies set 
          ...
          {/* Types of Cookies */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">3. Types of Cookies We Use</h2>
            <p className="text-blue-100 mb-4">
              We use the following types of cookies:
            </p>
            <ul className="text-blue-100 space-y-2 mb-4 list-disc pl-5">
              <li><strong className="text-cyan-200">Essential Cookies:</strong> These cookies are necessary for the website to function and cannot be switched off in our systems. They are usually only set in response to actions made by you which amount to a request for services, such as setting your privacy preferences, logging in, or filling in forms.</li>
              <li><strong className="text-cyan-200">Performance Cookies:</strong> These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us to know which pages are the most and least popular and see how visitors move around the site.</li>
              <li><strong className="text-cyan-200">Functionality Cookies:</strong> These cookies enable the website to provide enhanced functionality and personalization. They may be set by us or by third-party providers whose services we have added to our pages.</li>
              <li><strong className="text-cyan-200">Targeting Cookies:</strong> These cookies may be set through our site by our advertising partners. They may be used by those companies to build a profile of your interests and show you relevant advertisements on other sites.</li>
            </ul>
          </div>
          
          {/* How to Control Cookies */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">4. How to Control Cookies</h2>
            <p className="text-blue-100 mb-4">
            ...
            <p className="text-blue-100">
              ...
              <a href="http://www.aboutads.info/choices/" className="text-cyan-300 hover:text-cyan-200 ml-1">www.aboutads.info/choices</a> or 
              <a href="http://www.youronlinechoices.com" className="text-cyan-300 hover:text-cyan-200 ml-1">www.youronlinechoices.com</a>.
            </p>
          </div>
          
          {/* Updates to Cookie Policy */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">5. Updates to This Cookie Policy</h2>
            <p className="text-blue-100">
          ...
          {/* Contact */}
          <div className="bg-white/5 backdrop-blur-md border border-white/15 rounded-xl p-6 mb-8">
            <h2 className="text-xl font-semibold text-cyan-300 mb-4">6. Contact Us</h2>
            <p className="text-blue-100">
