...
const CollapsibleSection = ({ title, children, defaultOpen = true }) => {
    ...
    return (
        _jsxs("section", { 
            ...
            children: [
                _jsx("h4", { 
                    className: "text-lg text-cyan-300 mb-2 border-b border-[rgba(255,255,255,0.1)] pb-1 flex justify-between items-center cursor-pointer user-select-none",
...
const RelationshipGroup = ({ title, members }) => {
    ...
    return (
        _jsxs("div", { 
            ...
            children: [
                _jsx("h5", { 
                    className: "font-semibold text-cyan-400 mb-1 text-sm",
            ...
            children: isOpen && (
                _jsxs(_Fragment, { 
                    children: [
                        ...
                        _jsxs(motion.div, { 
                            className: "insights-panel fixed right-0 top-0 bottom-0 w-full sm:w-[350px] z-50 overflow-y-auto bg-gradient-to-b from-[#0b1020] to-[#111827] border-l border-[rgba(255,255,255,0.15)] shadow-[-5px_0_15px_rgba(0,0,0,0.2)] p-5",
                            ...
                            children: [
                                _jsx("div", {
                                    className: "close-insights absolute top-3 right-3 w-8 h-8 rounded-full bg-[rgba(34,211,238,0.15)] border border-cyan-400 text-cyan-400 font-bold leading-7 text-center cursor-pointer transition-all hover:bg-cyan-400 hover:text-[#0b1020] hover:rotate-90",
                                    onClick: onClose,
                                    children: "×"
                                }),
                                _jsx("img", { 
                                    ...
                                    alt: character.name, 
                                    className: "portrait w-[120px] h-[120px] rounded-full object-cover border-3 border-cyan-400 mx-auto mb-4 block",
                                    onError: (e) => {
                                        e.target.src = generateFallbackAvatar(character.name);
                                    } 
                                }),
                                _jsx("h3", { 
                                    className: "text-2xl font-bold text-cyan-400 mb-5 text-center",
                                                ...
                                                .map((ref, index) => (
                                                    _jsx("li", { 
                                                        ...
                                                        children: _jsx(ScriptureReference, { 
                                                            reference: ref.trim(), 
                                                            className: "scripture-reference text-cyan-300 underline cursor-pointer hover:bg-[rgba(34,211,238,0.2)] px-1 rounded" 
                                                        }) 
                                                    }, index)
                                                ))
                                        })
