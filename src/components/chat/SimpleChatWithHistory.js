...
const SimpleChatWithHistory = () => {
    ...
    // ------------------------------------------------------------------
    // Tenant-aware pricing URL for Upgrade CTA
    // ------------------------------------------------------------------
    ...
    useEffect(() => {
      const applyLessonContext = async () => {
        ...
        try {
          ...
          const ctx = `You are guiding a lesson conversation. ` +
            `Study: ${study.title}. ` +
            `Lesson ${lesson.order_index + 1}: ${lesson.title}. ` +
            `References: ${Array.isArray(lesson.scripture_refs) && lesson.scripture_refs.length > 0 ? lesson.scripture_refs.join(', ') : 'N/A'}. ` +
    ...
    useEffect(() => {
      ...
      let introText = `Greetings! I'm ${character.name}, and I'll be guiding you through this lesson.\n\n`;
      ...
      if (Array.isArray(lessonMeta.scripture_refs) && lessonMeta.scripture_refs.length > 0) {
        introText += `*References: ${lessonMeta.scripture_refs.join(', ')}*\n\n`;
      }
      ...
      introText += `Feel free to ask questions as we go through this study. I'm here to help you explore the material and apply insights to your work or life.\n\n`;
    ...
    return (
        _jsxs("div", {
            className: "relative min-h-screen bg-gradient-to-b from-indigo-950 via-indigo-900 to-indigo-800",
            children: [
                /* Background layers (stars / gradient blobs) */
                _jsxs("div", { 
                    className: "fixed inset-0", 
                    children: [
                        _jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-cyan-300/20 via-transparent to-transparent opacity-30" }),
                ...
                _jsx("div", { 
                    ...
                    children: _jsx("div", { 
                        ...
                        children: loadingConversation ? (
                            ...
                            _jsx("div", {
                                className: "flex h-full w-full items-center justify-center text-cyan-300 text-lg",
                                ...
                                children: [
                                            ...
                                            _jsxs("div", { 
                                                ...
                                                children: [
                                                    _jsx("img", { 
                                                        ...
                                                        alt: character.name, 
                                                        className: "h-12 w-12 rounded-full object-cover border-2 border-cyan-400 mr-3",
                                                        onError: (e) => {
                                                    ...
                                                    !isPremium && (
                                                      isExternalPricing ? (
                                                        _jsx("a", {
                                                          ...
                                                          className: "flex items-center gap-1 px-3 py-2 rounded-lg bg-cyan-400 text-gray-900 font-semibold border border-cyan-500 shadow hover:bg-cyan-300 transition-all",
                                                          children: "Upgrade"
                                                        })
                                                      ) : (
                                                        _jsx(Link, {
                                                ...
                                                _jsx("div", { 
                                                    ...
                                                    children: _jsxs("div", { 
                                                        ...
                                                        children: [
                                                            ...
                                                            _jsx("div", { 
                                                                className: "text-sm text-indigo-200 italic", 
                                    ...
                                    showSaveDialog && (
                                        _jsx("div", {
                                            ...
                                            children: _jsxs("div", {
                                                className: "bg-indigo-800 rounded-lg shadow-lg p-6 max-w-md w-full",
                                                children: [
                                                    _jsx("h3", {
                                                    ...
                                                    _jsxs("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            _jsx("button", {
                                                                ...
                                                                className: "px-4 py-2 bg-cyan-400 text-gray-900 rounded-md font-semibold hover:bg-cyan-300 transition-colors",
                                                                children: "Save"
                                                            })
                                                        ]
                                                    })
