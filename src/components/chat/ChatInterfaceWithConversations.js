                            ...
                            children: [
                                isAuthenticated && (
                                    _jsx("button", {
                                        ...
                                        className: "text-sm px-3 py-1 rounded bg-[rgba(34,211,238,.15)] border border-cyan-400 hover:bg-cyan-400 hover:text-[#0a0a2a] transition",
                                            ...
                                            _jsxs("div", {
                                                ...
                                                children: [
                                                    _jsx("input", {
                                                        ...
                                                        className: "bg-[rgba(255,255,255,.1)] border border-[rgba(255,255,255,.3)] rounded px-2 py-1 text-sm text-white focus:outline-none focus:ring-1 focus:ring-cyan-400 mr-2",
                                                        placeholder: "Enter conversation title..."
                                                    }),
                                                    _jsx("button", {
                                                        onClick: handleSaveTitle,
                                                        disabled: isSaving,
                                                        className: "text-xs px-2 py-1 bg-cyan-400 text-indigo-900 rounded hover:bg-cyan-300 transition-colors",
                                            ...
                                            _jsxs("div", {
                                                ...
                                                children: [
                                                    ...
                                                    _jsx("button", {
                                                        ...
                                                        className: "ml-2 text-xs text-white/70 hover:text-primary-400",
                                                        children: _jsx("svg", {
                                                            xmlns: "http://www.w3.org/2000/svg",
                                                            className: "h-3 w-3",
                                                            fill: "none",
                        ...
                        children: _jsxs("div", {
                            ...
                            children: [
                                ...
                                _jsx("input", {
                                    ...
                                    value: conversationTitle,
                                    onChange: (e) => setConversationTitle(e.target.value),
                                    className: "w-full px-3 py-2 bg-[rgba(255,255,255,.1)] border border-[rgba(255,255,255,.2)] rounded-md text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 mb-4",
                                ...
                                _jsxs("div", {
                                    ...
                                    children: [
                                        ...
                                        _jsx("button", {
                                            ...
                                            disabled: isSaving,
                                            className: "px-4 py-2 bg-cyan-400 text-indigo-900 rounded-md font-semibold hover:bg-cyan-300 transition-colors",
                                            children: isSaving ? "Saving..." : "Save"
                                        })
                                    ]
                                })
                                ...
                                _jsxs("div", {
                                    ...
                                    children: [
                                        ...
                                        _jsx("button", {
                                            ...
                                            className: "px-4 py-2 bg-cyan-400 text-indigo-900 rounded-r-md font-semibold hover:bg-cyan-300 transition-colors",
                                            children: "Copy"
                                        })
                                    ]
                                }),
