...
const ChatInterface = () => {
    ...
    if (!character) {
        return (
            _jsx("div", { 
                className: "flex h-full w-full flex-col items-center justify-center bg-gradient-to-b from-[#0b1020] via-[#0f172a] to-[#111827] p-4 text-white", 
                children: _jsxs("div", { 
                    className: "text-center", 
                    children: [
                        _jsx("svg", { 
                            xmlns: "http://www.w3.org/2000/svg", 
                            className: "h-16 w-16 mx-auto text-cyan-400 mb-4", 
                            fill: "none", 
                            viewBox: "0 0 24 24", 
                            stroke: "currentColor", 
                            children: _jsx("path", { 
                        ...
                        _jsx("p", { 
                            ...
                            children: "Select a character to begin your conversation." 
                        })
                    ] 
                }) 
            })
            ...
            children: [
                ...
                _jsxs("div", { 
                    ...
                    children: [
                        ...
                        _jsxs("button", { 
                            ...
                            id: "backBtn", 
                            className: "insights-toggle-button flex items-center gap-1 px-3 py-2 rounded-lg bg-[rgba(34,211,238,.2)] border border-cyan-400 text-cyan-400 font-semibold transition-all hover:bg-cyan-400 hover:text-indigo-900",
                            children: [
                                /* Left-arrow icon */
                                _jsx("svg", { 
                                    xmlns: "http://www.w3.org/2000/svg", 
                ...
                _jsxs("div", { 
                    ...
                    children: [
                        _jsxs("div", { 
                            ...
                            children: [
                                ...
                                _jsx("img", { 
                                    ...
                                    alt: character.name, 
                                    className: "h-8 w-8 md:h-12 md:w-12 rounded-full object-cover border-2 border-cyan-400 mr-2 md:mr-3",
                                    onError: (e) => {
                        ...
                        _jsxs("div", { 
                            ...
                            children: [
                                _jsxs("button", { 
                                    ...
                                    className: `insights-toggle-button flex items-center gap-1 px-2 py-1 text-xs md:px-3 md:py-2 md:text-sm rounded-lg ${showInsightsPanel ? 'bg-cyan-400 text-indigo-900' : 'bg-[rgba(34,211,238,.2)] border border-cyan-400 text-cyan-400'} font-semibold transition-all hover:bg-cyan-400 hover:text-indigo-900`,
                                    children: [
                                        _jsx("svg", { 
                                            xmlns: "http://www.w3.org/2000/svg", 
                                            className: "h-5 w-5", 
                                ...
                                _jsxs("button", { 
                                    id: "shareBtn", 
                                    className: "insights-toggle-button flex items-center gap-1 px-2 py-1 text-xs md:px-3 md:py-2 md:text-sm rounded-lg bg-[rgba(34,211,238,.2)] border border-cyan-400 text-cyan-400 font-semibold transition-all hover:bg-cyan-400 hover:text-indigo-900",
                                    onClick: handleShare,
                                    children: [
                                        _jsx("svg", { 
                                            xmlns: "http://www.w3.org/2000/svg", 
                        ...
                        /* Debate / Lecture toggle ------------------------------ */
                        _jsxs("div", {
                            className: "flex rounded-full overflow-hidden border border-cyan-400",
                            children: [
                                _jsx("button", {
                                    onClick: () => setDebateMode('Debate'),
                                    "aria-pressed": debateMode === 'Debate',
                                    className: `px-3 py-1 text-xs md:text-sm font-semibold transition-colors ${
                                        debateMode === 'Debate'
                ...
                character.feature_image_url && (_jsxs("div", {
                    ...
                    children: [
                        ...
                        character.opening_line && (_jsx("div", {
                            ...
                            children: _jsx("h3", {
                                className: "text-xl font-bold text-cyan-400 drop-shadow-lg",
                ...
                _jsx("div", {
                    className: "md:hidden sticky top-0 z-30 px-4 py-2 bg-[#0b1020]/80 backdrop-blur border-b border-[rgba(255,255,255,.15)]",
                    children: _jsxs("button", {
                        onClick: handleResetChat,
                        className: "flex items-center gap-2 text-cyan-300 hover:text-cyan-200 text-base font-semibold",
                        children: [
                            _jsx("svg", {
                                xmlns: "http://www.w3.org/2000/svg",
                                className: "h-4 w-4",
                ...
                _jsxs("div", { 
                    ...
                    children: [
                        _jsx("button", { 
                            ...
                            className: "rounded-full p-2 bg-indigo-800/80 backdrop-blur border border-cyan-400/30 text-cyan-200 shadow-md hover:bg-indigo-700/80 transition-colors",
                            children: _jsx("svg", { 
                                xmlns: "http://www.w3.org/2000/svg", 
                                className: "h-5 w-5", 
                                viewBox: "0 0 20 20", 
                        ...
                        showMobileActions && _jsx("div", { 
                            className: "mt-2 rounded-lg bg-indigo-900/90 backdrop-blur border border-cyan-400/30 p-1 shadow-xl",
