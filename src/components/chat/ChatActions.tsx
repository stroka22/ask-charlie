      ...
      <div className={`flex items-center space-x-2 ${className}`}>
        ...
        <button
          ...
          className={`rounded-full p-2 ${
            localFavorite ? 'bg-cyan-100 text-cyan-600' : 'bg-gray-100 text-gray-600'
    ...
    <div className={`border-t border-gray-200 bg-white p-4 ${className}`}>
      ...
      <div className="flex flex-wrap items-center gap-2">
        {!user && !bypassMode && !isChatSaved && (
          <div className="w-full mb-2 rounded-md bg-cyan-50 p-3 text-sm text-cyan-800">
            <div className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className={`h-5 w-5 mr-2 ${localFavorite ? 'text-cyan-600' : 'text-gray-600'}`}
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
