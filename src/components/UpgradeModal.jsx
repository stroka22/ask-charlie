...
const UpgradeModal = ({ 
  ...
  return (
    ...
    >
      {/* Modal Card */}
      <div 
        className="bg-gradient-to-br from-[#0b1020] via-[#0f172a] to-[#111827] rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl border border-white/10"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-center mb-4">
            <span className="bg-primary-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-md">
              Premium Feature
            </span>
          </div>
          ...
          <h2 
            ...
            className="text-2xl font-bold text-center text-primary-400 mb-4"
          ...
          <div className="bg-white/5 border border-white/10 rounded-md p-4 mb-6">
            <h3 className="text-primary-400 font-semibold mb-2">Premium Benefits:</h3>
            <ul className="text-white/80 text-sm space-y-2">
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary-400 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link 
              to={pricingUrl}
              className="bg-primary-500 hover:bg-primary-600 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-colors text-center"
            >
              Upgrade Now
            </Link>
            <button
