  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-3">
      <button
        ...
        className="flex items-center gap-2 px-5 py-3 bg-cyan-400 text-indigo-900 rounded-full shadow-lg hover:bg-cyan-300 transition-colors border border-cyan-500"
