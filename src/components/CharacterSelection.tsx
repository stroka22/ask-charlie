      ...
      pages.push(
        <button 
          ...
          className={`w-10 h-10 rounded-lg flex items-center justify-center ${
            currentPage === i 
              ? 'bg-primary-400 text-slate-900 font-bold' 
      ...
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-b from-[#0b1020] via-[#0f172a] to-[#111827]">
        <div className="text-center">
          <div className="relative mb-6">
            <div className="absolute inset-0 rounded-full bg-primary-300 blur-xl opacity-30 animate-pulse"></div>
            <div className="relative h-16 w-16 mx-auto animate-spin rounded-full border-4 border-primary-200 border-t-primary-400"></div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="w-full md:flex-1">
              <input
                ...
                className="w-full bg-white/10 border border-white/30 rounded-full py-2 px-4 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-primary-400/50"
              />
            </div>
            ...
            <div className="w-full md:w-auto">
              <select
                ...
                className="w-full md:w-auto bg-white/10 border border-white/30 rounded-full py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-primary-400/50"
              >
        ...
        {activeFilters.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-6 bg-white/5 p-3 rounded-lg">
            ...
            {activeFilters.map((filter, index) => (
              <div 
                key={index} 
                className="flex items-center gap-1 bg-primary-400/20 text-primary-300 px-3 py-1 rounded-full border border-primary-400/50"
              >
            ...
            <button 
              ...
              className="text-sm text-primary-300 hover:text-primary-200 ml-auto"
            >
              Clear All
            </button>
          </div>
              ...
              viewMode === 'grid' ? (
                ...
                <div 
                  ...
                  className={`
                    ...
                    ${selectedCharacter?.id === character.id ? 'border-primary-400 ring-2 ring-primary-400/30' : ''}
                  `}
                ...
                >
                  <img 
                    ...
                    className={`
                      ...
                      ${selectedCharacter?.id === character.id ? 'border-primary-400' : 'border-white/30'}
                    `}
                  />
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-primary-400">{character.name}</h3>
