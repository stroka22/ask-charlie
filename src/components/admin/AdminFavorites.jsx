...
const AdminFavorites = () => {
  ...
  const mockUsers = [
    { id: 'user1', name: 'Alex Rivera', email: 'alex@example.com' },
    { id: 'user2', name: 'Taylor Morgan', email: 'taylor@example.com' },
    { id: 'user3', name: 'Jordan Lee', email: 'jordan@example.com' },
    { id: 'user4', name: 'Community Team', email: 'team@example.org' }
  ];
              ...
              <div className="h-64 flex items-end space-x-2 pt-4 pb-2">
                {favoriteStats.slice(0, 10).map(stat => (
                  <div key={stat.id} className="flex flex-col items-center flex-1">
                    <div 
                      className="w-full bg-cyan-400 rounded-t-sm hover:bg-cyan-500 transition-all relative group"
                      style={{ 
