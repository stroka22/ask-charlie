    ...
    try {
      ...
      if (!featuredId) {
        ...
        setFeaturedSaveMessage({
          type: 'success',
          text: 'Featured assistant removed'
        });
      } else {
        ...
        setFeaturedSaveMessage({
          type: 'success',
          text: `${character.name} set as featured assistant`
        });
      }
      ...
      setFeaturedSaveMessage({
        type: 'error',
        text: 'Failed to save featured assistant'
      });
    } finally {
                  ...
                  <div className="flex items-center space-x-4">
                    {featuredSaveMessage.text && (
                      <div className={`text-sm ${
                        ...
                        featuredSaveMessage.type === 'warning' ? 'text-red-600' : 'text-blue-600'
                      }`}>
                        {featuredSaveMessage.text}
                      </div>
                    )}
                ...
                <div className="flex items-center space-x-4">
                  {saveMessage.text && (
                    <div className={`text-sm ${
                      ...
                      saveMessage.type === 'warning' ? 'text-red-600' : 'text-blue-600'
                    }`}>
                      {saveMessage.text}
                    </div>
                  )}
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  ...
                  Roundtable discussions allow multiple assistants to respond to topics and interact with each other.
                </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500">
                            Number of assistants that will respond in each round. For example, with 3 replies, three different assistants will speak in each round.
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-xs text-gray-500">
                            Additional responses after main replies. These create natural back-and-forth discussion between assistants.
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-xs text-gray-500">
                            Maximum words per assistant response. Higher values allow more detailed answers but can make discussions lengthy.
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Controls how strictly assistants adhere to source material. Lower values produce more conservative responses based closely on scripture.
                          </p>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-xs text-gray-500">
                            Maximum number of assistants in a roundtable. More participants create diverse discussions but each assistant speaks less frequently.
                      ...
                      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center">
                          ...
                          <label htmlFor="allowAllSpeak" className="ml-2 block text-sm text-gray-700">
                            ...
                            {rtLocks.allowAllSpeak && <span className="ml-1 text-xs text-red-600">(Locked)</span>}
                          </label>
                          <div className="ml-2">
                            <span
                              className="inline-block w-4 h-4 text-gray-400 cursor-help rounded-full bg-gray-100 text-center"
                              data-tooltip="When enabled, all assistants respond to each user message. With this disabled, only the configured number of replies per round will occur."
                            >
                              ?
                            </span>
                          </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <label htmlFor="strictRotation" className="ml-2 block text-sm text-gray-700">
                            Strict Rotation
                            {rtLocks.strictRotation && <span className="ml-1 text-xs text-red-600">(Locked)</span>}
                          </label>
                          <div className="ml-2">
                            <span
                              className="inline-block w-4 h-4 text-gray-400 cursor-help rounded-full bg-gray-100 text-center"
                              data-tooltip="When enabled, assistants take turns in a fixed order. Otherwise, there's some randomness in who speaks next."
                            >
                              ?
                            </span>
                          </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <label htmlFor="enableAdvanceRound" className="ml-2 block text-sm text-gray-700">
                            ...
                            {rtLocks.enableAdvanceRound && <span className="ml-1 text-xs text-red-600">(Locked)</span>}
                          </label>
                          <div className="ml-2">
                            <span
                              className="inline-block w-4 h-4 text-gray-400 cursor-help rounded-full bg-gray-100 text-center"
                              data-tooltip="Shows a button to advance to the next round without requiring user input. Assistants will continue discussing the topic."
                            >
                              ?
                            </span>
                          </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <label htmlFor="saveByDefault" className="ml-2 block text-sm text-gray-700">
                            Save By Default
                            {rtLocks.saveByDefault && <span className="ml-1 text-xs text-red-600">(Locked)</span>}
                          </label>
                          <div className="ml-2">
                            <span
                              className="inline-block w-4 h-4 text-gray-400 cursor-help rounded-full bg-gray-100 text-center"
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          <p className="text-xs text-gray-500">
                            Maximum number of assistants allowed in any roundtable.
                      ...
                      <div className="flex items-center space-x-4">
                        {rtMessage.text && (
                          <div className={`text-sm ${
                            ...
                            rtMessage.type === 'warning' ? 'text-red-600' : 'text-blue-600'
                          }`}>
                            {rtMessage.text}
                          </div>
                        )}
