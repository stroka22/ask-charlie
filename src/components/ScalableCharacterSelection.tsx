...
const ScalableCharacterSelection: React.FC = () => {
      ...
      return (
        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-cyan-400">{character.name}</h3>
  ...
  if (isLoading) {
    return (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-b from-[#0b1020] via-[#0f172a] to-[#111827]">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0b1020] via-[#0f172a] to-[#111827] py-10 px-4 md:px-6">
        ...
        {featuredCharacter && (
          <div className="mb-12 flex flex-col items-center">
            <div className="relative mb-4">
              {/* Halo effect */}
              <div className="absolute -inset-4 rounded-full bg-cyan-300 blur-xl opacity-30"></div>
              ...
              <table className="border-collapse m-0 p-0 relative z-0">
                <tbody>
                  <tr>
                    <td
                      className="w-32 h-32 rounded-full overflow-hidden p-0 border-4 border-cyan-300 shadow-xl bg-blue-50"
                    >
                      <img
                        src={
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="w-full md:flex-1">
              <input
                ...
                className="w-full bg-white/10 border border-white/30 rounded-full py-2 px-4 text-white placeholder-blue-100 focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
              />
            </div>
            ...
            <div className="w-full md:w-auto">
              <select
                ...
                className="w-full md:w-auto bg-white/10 border border-white/30 rounded-full py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
              >
        ...
        {activeFilters.length > 0 && (
          <div className="flex flex-wrap gap-2 mb-6 bg-white/5 p-3 rounded-lg">
            ...
            <button 
              ...
              className="text-sm text-indigo-300 hover:text-indigo-200 ml-auto"
            >
              Clear All
            </button>
          </div>
      ...
      <span
        className="fixed bottom-3 left-3 z-50 rounded-full bg-cyan-400/90 px-3 py-1 text-xs font-semibold text-indigo-900 shadow-lg select-none"
