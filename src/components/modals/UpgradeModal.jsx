...
const UpgradeModal = ({ 
  ...
  return createPortal(
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-indigo-950/80 backdrop-blur-sm transition-all duration-300"
      onClick={onClose}
    >
      {/* Modal Content */}
      <div 
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-indigo-950 to-indigo-900 px-6 py-4 flex justify-between items-center">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-5">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg className="h-5 w-5 text-cyan-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Access to all assistants</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-cyan-500 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
        ...
        <div className="px-6 py-4 bg-gray-50 flex flex-col sm:flex-row-reverse gap-3">
          {isExternalPricing ? (
            <a
              ...
              className="inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-gray-900 bg-cyan-400 hover:bg-cyan-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-colors"
            >
              Upgrade Now
            </a>
          ) : (
          ...
          <button
            type="button"
            onClick={onClose}
            className="inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
          >
            Maybe Later
          </button>
        </div>
