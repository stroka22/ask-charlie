...
class SimpleErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="p-4 bg-cyan-100 border-l-4 border-cyan-500 text-cyan-700">
...
const Navigation = () => (
  <nav className="bg-blue-900 text-white p-4">
    <div className="container mx-auto flex justify-between items-center">
      <div className="text-xl font-bold">Bot360AI (Bypass Mode)</div>
...
const HomePage = () => (
  <div className="container mx-auto p-8">
    <h1 className="text-3xl font-bold mb-6">Welcome to Bot360AI</h1>
...
if (!root) {
  ...
  console.log("[Bypass] Starting Bot360AI in bypass mode (no API dependencies)");
